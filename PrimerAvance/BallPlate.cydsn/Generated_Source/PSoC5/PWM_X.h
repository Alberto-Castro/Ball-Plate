...
#define PWM_X_UsingFixedFunction             (1u)
#define PWM_X_DeadBandMode                   (0u)
#define PWM_X_KillModeMinTime                (0u)
#define PWM_X_KillMode                       (1u)
#define PWM_X_PWMMode                        (0u)
...
#define PWM_X_UseOneCompareMode              (1u)
...
#define PWM_X_INIT_COMPARE_VALUE1        (1500u)
#define PWM_X_INIT_COMPARE_VALUE2        (63u)
...
#define PWM_X_DEFAULT_COMPARE2_MODE      (uint8)((uint8)1u <<  PWM_X_CTRL_CMPMODE2_SHIFT)
