/*******************************************************************************
* File Name: ResistiveTouch_AMux.c
* Version 1.80
*
*  Description:
...
uint8 ResistiveTouch_AMux_initVar = 0u;


/*******************************************************************************
* Function Name: ResistiveTouch_AMux_Start
********************************************************************************
* Summary:
...
{
    ResistiveTouch_AMux_DisconnectAll();
    ResistiveTouch_AMux_initVar = 1u;
}


/*******************************************************************************
* Function Name: ResistiveTouch_AMux_Init
********************************************************************************
* Summary:
*  Disconnect all channels. The next time Next is called, channel 0 will be
*  connected.
...
/*******************************************************************************
* Function Name: ResistiveTouch_AMux_Stop
********************************************************************************
* Summary:
*  Disconnect all channels. The next time Next is called, channel 0 will be
*  connected.
...
/*******************************************************************************
* Function Name: ResistiveTouch_AMux_Next
********************************************************************************
* Summary:
...
{
    ResistiveTouch_AMux_CYAMUXSIDE_A_Next();
    ResistiveTouch_AMux_CYAMUXSIDE_B_Next();
}


/*******************************************************************************
* Function Name: ResistiveTouch_AMux_DisconnectAll
********************************************************************************
* Summary:
...
{
    ResistiveTouch_AMux_CYAMUXSIDE_A_DisconnectAll();
    ResistiveTouch_AMux_CYAMUXSIDE_B_DisconnectAll();
}


/*******************************************************************************
* Function Name: ResistiveTouch_AMux_GetChannel
********************************************************************************
* Summary:
...
{
    return ResistiveTouch_AMux_CYAMUXSIDE_A_curChannel;
}
...
int8 ResistiveTouch_AMux_GetChannel(void)
{
    return ResistiveTouch_AMux_curChannel;
}
