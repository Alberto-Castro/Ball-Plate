...
{
    uint8 staticBits = (Pin_wakeup_DR & (uint8)(~Pin_wakeup_MASK));
    Pin_wakeup_DR = staticBits | ((uint8)(value << Pin_wakeup_SHIFT) & Pin_wakeup_MASK);
}
...
{
	CyPins_SetPinDriveMode(Pin_wakeup_0, mode);
}
...
{
    return (Pin_wakeup_PS & Pin_wakeup_MASK) >> Pin_wakeup_SHIFT;
}
...
{
    return (Pin_wakeup_DR & Pin_wakeup_MASK) >> Pin_wakeup_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Pin_wakeup_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Pin_wakeup_0_INTR) != 0u) 
		{ 
			 Pin_wakeup_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Pin_wakeup_INTSTAT & Pin_wakeup_MASK) >> Pin_wakeup_SHIFT;
    }
