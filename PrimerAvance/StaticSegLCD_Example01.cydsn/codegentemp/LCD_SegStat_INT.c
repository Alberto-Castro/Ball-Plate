...
*
 ******************************************************************************/
CY_ISR(LCD_SegStat_ISR)
{
    #ifdef LCD_SegStat_ISR_INTERRUPT_CALLBACK
        LCD_SegStat_ISR_InterruptCallback();
    #endif /* LCD_SegStat_ISR_INTERRUPT_CALLBACK */
