...
extern const struct CY_DMA_TD_PROTO_ENTRY CYCODE LCD_SegStat_Com__DMA_TD_PROTO_BLOCK[1] CY_DEPRECATED;
#define LCD_SegStat_Com__DMA_TD_PROTO_COUNT 1
extern const struct CY_DMA_TD_PROTO_ENTRY CYCODE LCD_SegStat_Seg__DMA_TD_PROTO_BLOCK[1] CY_DEPRECATED;
#define LCD_SegStat_Seg__DMA_TD_PROTO_COUNT 1
